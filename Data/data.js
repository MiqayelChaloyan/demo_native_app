...
function DNAdata({children}) {
  const [feedData, setFeedData] = useState([
    ...
    },
    {
      title: 'ULTRABOOST',
      message:
        'You can try any of our performance running shoes for 30 days and return hassle-free.',
      imageUri:
    ...
    },
    {
      ...
      message:
        'Great catch! This exclusive product is only available at adidas and can`t be found anywhere else. ',
      imageUri:
    ...
    },
    {
      ...
      message:
        'Make an impression in these adidas Forum shoes that mix `80s hoops heritage with modern energy. ',
      imageUri:
