...
const styles = StyleSheet.create({
  ...
  leftArrow: {
    ...
    zIndex: -1,
    borderTopWidth: horizontalScale(30 / 2.0),
    borderRightWidth: horizontalScale(0),
    borderBottomWidth: horizontalScale(50 / 2.0),
    borderLeftWidth: horizontalScale(30),
  ...
  rightArrow: {
    ...
    right: verticalScale(19),
    zIndex: -1,
    borderTopWidth: horizontalScale(40 / 2.0),
    borderRightWidth: 0,
    borderBottomWidth: horizontalScale(40 / 2.0),
    borderLeftWidth: horizontalScale(30),
    borderTopColor: 'transparent',
    borderRightColor: 'transparent',
    borderBottomColor: 'transparent',
