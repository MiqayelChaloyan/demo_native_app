...
const CardPaymentSystem = ({navigation}) => {
    ...
    return (
        <View>
            <StatusBar backgroundColor={theme.colors.light_grey} barStyle="light-content" />
            ...
            {creditCardData.length < 3 ? (
                ...
                <Text style={styles.maximumCards}>You can attach a maximum of three cards.</Text>
            )}
        </View>
    );
}
...
export default React.memo(CardPaymentSystem);