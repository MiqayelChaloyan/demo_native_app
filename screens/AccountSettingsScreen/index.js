        ...
        <>
            <ScrollView style={styles.container}>
                <View style={styles.block}>
                    <HeaderPreferences navigation={navigation} screen={'SettingsNav'} option={'Account Settings'}/>
            ...
            {isVisible && <BottomSheet children={<CardPaymentSystem navigation={navigation} />} onClose={handleClose} />}
        </>
    );
};
